...
public class JoinRowSetTest {
	public static void main(String[] args) {
		...
		try {
			...
			crs1.setUsername("SAIKIRAN");
			crs1.setPassword("SAIKIRAN");
			...
			crs2.setUsername("SAIKIRAN");
			crs2.setPassword("SAIKIRAN");
			...
			// Process JoinRowSet
			while (joinRS.next()) {
				System.out.println(joinRS.getString(1) + "  " + joinRS.getString(2) + "  " + joinRS.getString(3) + "  "
						+ joinRS.getString(4) + "  " + joinRS.getString(5));
			}
		} // try
