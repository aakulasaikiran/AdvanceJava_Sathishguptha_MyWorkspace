...
public class Servlet4 extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		//read request attribute values
		 pw.println("<br>(Servlet4) attr1(request) attribute value::"+req.getAttribute("attr1"));
		...
		//read ServletContext attribute values
		 ...
		 pw.println("<br>(Servlet4) attr3(Servletcontext) attribute value:"+sc.getAttribute("attr3"));
