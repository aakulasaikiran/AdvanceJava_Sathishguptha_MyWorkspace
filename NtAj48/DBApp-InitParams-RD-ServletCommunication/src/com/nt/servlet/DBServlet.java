...
{ 
	...
	public void doGet(HttpServletRequest req,HttpServletResponse res)throws ServletException,IOException{
		...
		//generate body logic	
		pw.println("<h1>DBServlet:::Before critical statement</h1>");	
		//read form data
		...
		rd2.include(req,res);
			...
			pw.println("<b>DBServlet:Before rd.forward(-,-)");
			System.out.println("DBServlet:before rd.forward(-,-)");
			rd=req.getRequestDispatcher("/errurl");
			rd.forward(req,res);
			System.out.println("DBServlet:after rd.forward(-,-)");
			pw.println("<b>DBServlet:After rd.forward(-,-)");
		}
		finally{
			try{
				if(rs!=null)
